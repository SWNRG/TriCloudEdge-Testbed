 ...
 * @return esp_err_t ESP_OK if the message was  queued successfully for sending 
 * to at least one client.
 * ESP_ERR_NOT_FOUND if no clients are connected or other error codes on failure.
 */
